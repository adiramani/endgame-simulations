...
from endgame_simulations.models import BaseInitialParams, BaseProgramParams, EndgameModel, _BaseUpdateParams
...
class GenericSimulation(Generic[ParamsModel, State], ABC):
    ...
    def __init__(
        ...
        *,
        ...
        if params:
            state = self.state_class.from_params(
                params, start_time or 0.0
            )
...
class GenericEndgame(Generic[ParamsModel, UpdateParamsModel, ProgramModel, State, CombinedParams]):
    ...
    def __init__(
        ...
        *, 
        start_time: float | None = None,    
        endgame: EndgameModel[ParamsModel, UpdateParamsModel, ProgramModel] | None = None,
        input: FileType | None = None,
        verbose: bool = False,
        debug: bool = False,
    ) -> None:
